...
@InputType()
class FavorisCreateNestedManyWithoutUtilisateursInput {
...
export { FavorisCreateNestedManyWithoutUtilisateursInput as FavorisCreateNestedManyWithoutUtilisateursInput };
