...
@InputType()
class FavorisCreateNestedManyWithoutPanierMysteresInput {
...
export { FavorisCreateNestedManyWithoutPanierMysteresInput as FavorisCreateNestedManyWithoutPanierMysteresInput };
